...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Dfq-WLHB.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-_vwHl8xn.js").then((n) => n.r),
    import("./start-D-_8CyFf.js"),
...
var ROUTER_BASEPATH = "final-round-fight-club";
var SERVER_FN_BASE = "/final-round-fight-club/_serverFn/";
