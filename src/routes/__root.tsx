  ...
  head: () => ({
    meta: [
      ...
      { title: "Final Round Fight Club — Elite Martial Arts Academy" },
      {
        name: "description",
        content:
          "Train like a warrior, fight like a champion. Elite MMA, Boxing, Muay Thai, BJJ & more at Final Round Fight Club. Book your free trial today.",
      },
      ...
      { property: "og:title", content: "Final Round Fight Club — Elite Martial Arts Academy" },
      {
        ...
        content:
          "World-class combat training across 10 disciplines. Forge your warrior spirit at Final Round Fight Club.",
      },
